// client/src/Components/STOCK/StockView.js
...
export default function StockView() {
  ...
  const handlePrint = () => {
    if (!rows || rows.length === 0) {
      alert("No stock data to print. Apply filters or search first.");
      return;
    }
    window.print();
  };
  ...
  return (
    <>
      <div className="no-print">
        <Navbar />
        {/* 🔁 Match outer size to GRNCreate */}
        <div className="max-w-7xl mx-auto mt-8 px-4 md:px-6">
          {/* 🔁 Card size / shadow / padding similar to GRNCreate */}
          ...
          {/* Grid header – font like GRN items header */}
          ...
          {/* Grid rows – text-base like GRN rows */}
          ...
          return (
            <div style={{ fontFamily: "Arial, sans-serif" }}>
              ...
              <div style={{ textAlign: "center", marginBottom: 8 }}>
                ...
                {phone ? <div style={{ fontSize: 12 }}>Tel: {phone}</div> : null}
              ...
              {/* Footer note like GRNs/Issue notes */}
            </div>
          );
        })()}
      </div>
